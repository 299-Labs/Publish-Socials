...
class TestPublisher(unittest.TestCase):
    ...
    def test_publisher_initialization(self, mock_linkedin, mock_substack, 
                                     mock_medium, mock_reddit, mock_x):
    ...
    def test_test_all_connections(self):
        ...
        mock_medium = Mock()
        mock_medium.test_connection.return_value = {'success': True, 'user': 'mediumuser'}
        
        mock_substack = Mock()
        mock_substack.test_connection.side_effect = Exception("Substack error")
        
        mock_linkedin = Mock()
        mock_linkedin.test_connection.return_value = {'success': True, 'user': 'linkedinuser'}

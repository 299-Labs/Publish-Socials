...
from publish_socials_package.utils import (
    ContentFormatter,
    generate_slug,
    sanitize_filename,
    validate_article,
...
class TestValidateArticle(unittest.TestCase):
    ...
    def test_empty_title(self):
        ...
        article = {"title": "", "content": "Test content"}
    ...
    def test_short_content(self):
        ...
        article = {"title": "Test Title", "content": "Short"}
    ...
    def test_long_title(self):
        ...
        article = {"title": "A" * 201, "content": "Test content"}

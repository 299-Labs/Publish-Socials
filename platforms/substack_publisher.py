...
class SubstackPublisher:
    ...
    def _create_post(self, title: str, body: str, publish_status: str = 'draft',
                    tags: list = None, send_to_subscribers: bool = False) -> Dict[str, Any]:
        """
    ...
    def update_post(self, post_id: str, title: str = None, 
                   body: str = None, tags: list = None) -> Dict[str, Any]:
        """
    ...
    def schedule_post(self, article: Dict[str, Any], 
    ...
    def _create_scheduled_post(self, title: str, body: str, 
                             schedule_time: str, tags: list = None,
                             send_to_subscribers: bool = False) -> Dict[str, Any]:
        """

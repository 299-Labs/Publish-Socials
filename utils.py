...
class ContentFormatter:
    ...
    def format_for_platform(self, content: str, platform: str, 
    ...
    def _format_for_longform(self, content: str, title: Optional[str], 
                           platform: str) -> str:
    ...
    def truncate_content(self, content: str, max_length: int, 
                        suffix: str = "...") -> str:
        """
...
def validate_article(article: Dict[str, Any]) -> None:
    ...
    if 'publish_date' in article:
        try:
            ...
            raise ValidationError("Invalid publish_date format. Use ISO format (YYYY-MM-DD)")
